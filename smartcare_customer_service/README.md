...
| 成员 | 主要职责 | 答辩讲解部分 |
| --- | --- | --- |
| 成员 A | 选题分析、需求分析、知识库构建、RAG 检索 | 项目背景、系统架构、知识库与 RAG 检索 |
| 成员 B | 意图识别、Agent 路由、Function Calling、情绪兜底 | 意图路由、工具调用、安全策略 |
| 成员 C | Web 界面、SQLite 记忆、多轮状态维护、功能演示 | 记忆系统、Web 界面、现场演示 |
| 成员 D | 评估脚本、消融实验、实验分析、总结改进 | 实验评估、结果分析、未来展望 |
